 ...
 */
@Deprecated
public class FormattedContentSink implements FormattedCharSink {
    private final List<Map.Entry<StringBuilder, Style>> builders;

    public FormattedContentSink() {
    ...
    @FunctionalInterface
    public interface FormattedContentComposer<T> extends Function<FormattedContentSink, T> {
