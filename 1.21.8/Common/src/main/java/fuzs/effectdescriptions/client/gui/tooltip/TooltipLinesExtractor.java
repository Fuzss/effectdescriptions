...
public abstract class TooltipLinesExtractor<T, C extends ClientConfig.TooltipComponents> {
    ...
    public static <T, C extends ClientConfig.TooltipComponents> List<Component> getTooltipLines(List<TooltipLinesExtractor<T, C>> extractorList, Component decorationComponent, Style style, T t, C tooltipComponents) {
