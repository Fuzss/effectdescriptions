...
public class ModLanguageProvider extends AbstractLanguageProvider {
    ...
    public void addTranslations(TranslationBuilder builder) {
        ...
        addMobEffect(builder, MobEffects.DAMAGE_BOOST, "Increases dealt melee damage.");
        addMobEffect(builder, MobEffects.HEAL, "Heals living entities, damages undead.");
        addMobEffect(builder, MobEffects.HARM, "Damages living entities, heals undead.");
        ...
        addMobEffect(builder, MobEffects.FIRE_RESISTANCE, "Prevents taking damage from fire sources, like fire and lava.");
        ...
        addMobEffect(builder, MobEffects.BLINDNESS, "Impairs vision and disables the ability to sprint and critical hit.");
        addMobEffect(builder, MobEffects.NIGHT_VISION, "Lets the player see well in darkness and underwater.");
        addMobEffect(builder, MobEffects.HUNGER, "Increases food exhaustion.");
        addMobEffect(builder, MobEffects.WEAKNESS, "Decreases dealt melee damage.");
        addMobEffect(builder, MobEffects.POISON, "Inflicts damage over time, but doesn't kill.");
        addMobEffect(builder, MobEffects.WITHER, "Inflicts potentially deadly damage over time.");
        ...
        addMobEffect(builder, MobEffects.CONDUIT_POWER, "Increases underwater visibility and mining speed, prevents drowning.");
        ...
        addMobEffect(builder, MobEffects.HERO_OF_THE_VILLAGE, "Gives discounts on trades with villagers, and makes villagers throw gifts.");
        ...
        builder.add("effect.alexsmobs.debilitating_sting.desc", "An Effect which poisons the victim but paralyzes arthropods. It will stop if the victim is at half health and is not an arthropod. Inflicted by a Tarantula Hawk.");
        builder.add("effect.alexsmobs.ender_flu.desc", "After the effect runs out naturally); the user takes massive damage and an Enderiophage will spawn. Inflicted by an Enderiophage.");
        builder.add("effect.alexsmobs.exsanguination.desc", "Gradually drains health.");
        builder.add("effect.alexsmobs.fear.desc", "Makes the target unable to move. Effect applied when a Tiger reveals itself to the user.");
        ...
        builder.add("effect.alexsmobs.oiled.desc", "Oil floats on water. Cover yourself in oil to float on the surface of water and outside in the rain.");
        builder.add("effect.alexsmobs.orcas_might.desc", "Grants increased attack speed. Effect may be applied when swimming with an Orca.");
        ...
        builder.add("effect.alexsmobs.sunbird_blessing.desc", "Decreases fall speed); prevents fall damage and makes it easier to fly with an Elytra or Tarantula Hawk Elytra. Effect is applied when near a Sunbird.");
        builder.add("effect.alexsmobs.sunbird_curse.desc", "Increases fall speed); causing the user to hit the ground quicker. This effectively impedes the use of an Elytra. Effect is applied when attacking a Sunbird.");
        builder.add("effect.alexsmobs.tigers_blessing.desc", "Tigers near the user will be neutral and will protect them from hostile foes. The effect will go away early when attacking a Tiger. Applied by feeding a Tiger chicken or pork chops.");
        ...
        builder.add("effect.farmersdelight.nourishment.description", "Prevents hunger and saturation loss unless damaged.");
        ...
        builder.add("effect.mynethersdelight.g_pungent.desc", "Alleviates burning, regenerate health near heat sources with fire protection armor or fire resistance effect.");
        builder.add("effect.mynethersdelight.b_pungent.desc", "Alleviates burning, regenerate health near heat sources with fire protection armor or fire resistance effect.");
        builder.add("effect.mynethersdelight.g_pungent.description", "Alleviates burning, regenerate health near heat sources with fire protection armor or fire resistance effect.");
        builder.add("effect.mynethersdelight.b_pungent.description", "Alleviates burning, regenerate health near heat sources with fire protection armor or fire resistance effect.");
        builder.add("effect.supplementaries.overencumbered.desc", "Prevents sprinting. Further levels reduce jump height hinder walking speed respectively");
